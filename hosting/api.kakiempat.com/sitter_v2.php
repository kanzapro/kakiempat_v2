 ...
 * POST ?action=upload_verification
...
try {
    switch ($action) {
        ...
        case 'set_availability':
            ...
            kakiempat_sitter_v2_set_availability(v2ApiBody());
            break;
        ...
        case 'upload_verification':
            ...
            kakiempat_sitter_v2_upload_verification(v2ApiBody());
            break;
        case 'get_badges':
            if ($method !== 'GET') {
                v2ApiFail('method_not_allowed', 'Gunakan metode GET.', 405);
            }
            kakiempat_sitter_badges_v2_get_for_sitter();
            break;
        case 'get_profile':
            if ($method !== 'GET') {
                v2ApiFail('method_not_allowed', 'Gunakan metode GET.', 405);
        ...
        default:
            v2ApiFail(
                'action_required',
                'Gunakan save_profile, set_availability, submit_verification, upload_verification, get_profile, '
                . 'get_badges, get_wallet, request_withdraw, atau list_my_withdrawals.',
                400,
            );
    }
} catch (Throwable $e) {
