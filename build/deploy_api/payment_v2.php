...
$actionAliases = [
    'submit_proof' => 'submit_payment_proof',
    'admin_approve' => 'admin_approve_payment',
    'admin_reject' => 'admin_reject_payment',
];
...
switch ($action) {
    ...
    default:
        v2ApiFail(
            'unknown_action',
            'Aksi tidak dikenali. Gunakan submit_proof, submit_payment_proof, admin_approve, admin_approve_payment, admin_reject_payment, list_pending_verification, get_payment_config.',
            400,
        );
}
