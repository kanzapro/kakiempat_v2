...
/** @return array{total: int, services: list<array<string, mixed>>, categories: list<array<string, mixed>>} */
function kakiempat_service_v2_build_catalog_payload(PDO $pdo): array
{
